...
fecha_clara = datetime.datetime(2004, 5, 14)
fecha_juana = datetime.datetime(2004, 2, 13)
fecha_felipe = datetime.datetime(2004, 12, 18)
fecha_justo = datetime.datetime(2003, 5, 20)
