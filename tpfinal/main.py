...
JUSTO = Receptores(46333111, 'Justo', fecha_justo, 'M', 1145451111, 'AB', SWISSMEDICAL, 0, 3, 'Paro', True, 'corazon')
INCUCAI=Incucai([],[],[SWISSMEDICAL,AUSTRAL,ALEMAN])

INCUCAI.registrar_paciente_receptor(JUANA)
print(INCUCAI.lista_receptores)
INCUCAI.registrar_paciente_donante(CLARA)
print(INCUCAI.lista_donantes)
print(INCUCAI.lista_receptores)
print(CLARA.listado_organos_donar)
INCUCAI.registrar_paciente_receptor(FELIPE)
INCUCAI.registrar_paciente_receptor(JUSTO)
print(INCUCAI.lista_receptores)
print(CLARA.listado_organos_donar)